...
```bash
bash <(curl -s https://raw.githubusercontent.com/yourusername/jianzhan/main/deploy.sh)
```

或下载后手动运行：

```bash
wget https://raw.githubusercontent.com/yourusername/jianzhan/main/deploy.sh
chmod +x deploy.sh
./deploy.sh
```
